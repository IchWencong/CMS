$( function(){
	...
	var turnPages=Math.ceil(navList.length/turnPage);
	//初始图片区域高度与标题区域宽度
	imgField.height(imgList.length*imgList.height());
	navField.width(navList.length*navListW);
